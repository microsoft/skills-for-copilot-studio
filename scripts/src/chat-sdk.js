/**
 * chat-sdk.js — Send a single utterance to a published Copilot Studio agent
 * via the Copilot Studio Client SDK (M365 Agents SDK).
 *
 * This script always uses the SDK path regardless of the agent's authentication
 * mode. It does NOT auto-detect — the caller (skill/LLM) decides which protocol
 * to use.
 *
 * Usage:
 *   node chat-sdk.bundle.js --client-id <id> "your message"
 *   node chat-sdk.bundle.js --client-id <id> "your message" --agent-dir <path>
 *   node chat-sdk.bundle.js --client-id <id> "follow-up" --conversation-id <id>
 *
